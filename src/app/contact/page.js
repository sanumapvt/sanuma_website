      ...
      <div className="pt-32 sm:pt-40 pb-24 sm:pb-32 bg-white">
        <Container>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14">
            ...
            <address className="not-italic lg:col-span-7 space-y-6">
              {/* Email Card */}
              <div className="p-8 rounded-2xl bg-[#F7F9F9] border border-[#E5EAEA] hover:border-[#009688]/40 transition-colors">
              ...
              {/* Location Card */}
              <div className="p-8 rounded-2xl bg-[#F7F9F9] border border-[#E5EAEA]">
                <div className="w-10 h-10 rounded-xl bg-[#009688]/10 text-[#009688] flex items-center justify-center mb-4">
            ...
            <div className="lg:col-span-5 flex flex-col justify-between p-8 sm:p-10 rounded-3xl bg-[#172121] text-white">
              <div>
