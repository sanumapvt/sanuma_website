  ...
  return (
    ...
    >
      ...
      <Container className="relative z-10">
        ...
        {/* ========================================================================= */}
        {/* RESPONSIVE 360° VIEW: Mobile Stack (<lg) & Desktop 12-Col Grid (>=lg)     */}
        {/* ========================================================================= */}

        {/* 1. MOBILE & TABLET (< lg): Full-Width Touch Grid + Full-Width HUD Card */}
        <div className="lg:hidden flex flex-col gap-6 w-full max-w-lg mx-auto">
          {/* 3x3 Department Touch Selector */}
            ...
            {DEPARTMENTS.map((dept) => {
              ...
              return (
                <button
                  ...
                  className={`p-3 rounded-2xl border transition-all duration-150 flex flex-col items-center justify-center text-center cursor-pointer active:scale-95 ${
                    isSelected
                      ? "bg-[#00E5D0]/15 border-[#00E5D0] shadow-lg shadow-[#00E5D0]/20"
          ...
          {/* Full-Width Mobile HUD Card */}
          <div className="w-full">
            <div
              key={`mobile-card-${activeDept.id}`}
              className="p-5 sm:p-7 rounded-2xl sm:rounded-3xl bg-[#091313] border shadow-2xl relative overflow-hidden w-full"
              style={{
            ...
            >
              ...
              <div className="flex items-center gap-3.5 mb-4">
                <div
                  className="w-12 h-12 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-md border"
                  style={{
              ...
              {/* Description */}
              <p className="text-sm text-[#F7F9F9]/85 leading-relaxed mb-4">
                {activeDept.description}
              </p>

              {/* Key Systems Checklist */}
              <div className="space-y-2 mb-5 pt-3 border-t border-white/10">
                {activeDept.systems.map((sys, idx) => (
                  <div key={idx} className="flex items-start gap-2 text-xs text-[#F7F9F9]/75">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#00E5D0] mt-1.5 flex-shrink-0" />
                    <span>{sys}</span>
                  </div>
                ))}
              </div>

              {/* How We Build Link & Telemetry Metric */}
              <div className="pt-3.5 border-t border-white/10 flex items-center justify-between">
                <Link
                  href="/how-we-build"
                  className="inline-flex items-center gap-1.5 text-sm font-semibold text-[#00E5D0] hover:text-white transition-all group"
                >
        ...
        <div className="hidden lg:grid grid-cols-12 gap-8 xl:gap-12 items-center">
          ...
          >
            ...
            <div className="relative w-[540px] h-[540px] flex items-center justify-center">
              <div className="absolute w-[540px] h-[540px] origin-center flex items-center justify-center">
                ...
                <div className="relative z-30 flex flex-col items-center justify-center w-32 h-32 rounded-full bg-gradient-to-b from-[#132424] via-[#0E1A1A] to-[#060B0B] border-2 border-[#00E5D0] shadow-[0_0_50px_rgba(0,229,208,0.4)] group cursor-pointer">
          ...
          {/* Right 5 Columns: Desktop HUD Card */}
          <div className="col-span-5 w-full">
            <div
              key={`desktop-card-${activeDept.id}`}
              className="p-6 xl:p-8 rounded-3xl bg-[#091313] border shadow-[0_20px_50px_-10px_rgba(0,0,0,0.7)] relative overflow-hidden w-full"
              style={{
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="text-xl xl:text-2xl font-extrabold text-white tracking-tight leading-snug">
                    {activeDept.name}
                  </h3>
                  <div
                    className="text-xs font-semibold uppercase tracking-wider mt-0.5"
              ...
              {/* Description */}
              <p className="text-sm text-[#F7F9F9]/80 leading-relaxed mb-5">
                {activeDept.description}
              </p>
              ...
              <div className="space-y-2 mb-6 pt-3 border-t border-white/10">
                {activeDept.systems.map((sys, idx) => (
                  <div key={idx} className="flex items-start gap-2 text-xs text-[#F7F9F9]/70">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#00E5D0] mt-1.5 flex-shrink-0" />
                    <span>{sys}</span>
                  </div>
                ))}
